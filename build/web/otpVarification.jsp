                            ...
                            <div class="all-blog-posts">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12" style="height: 100vh">
                                        ...
                                        <form action="SmsController?op=varifyotp">
                                            <table class="table" width='50%'>
                                                ...
                                                <tr>
                                                    <td colspan="2"><input type="button" name="submit" value="SEND OTP" class="btn btn-primary form-control " 
                                                                           onclick="ValidateDataAndSendOtp(userid.value,mobile.value, s1);"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Enter otp </td>
                                                ...
                                                <tr>
                                                    <td colspan="2"> <input type="button" value="Submit Otp" name="varify" 
