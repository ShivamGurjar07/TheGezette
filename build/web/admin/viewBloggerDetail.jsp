                    ...
                    <div class="container-fluid"> 
                        ...
                        <div class="row">
                            ...
                            <%
                                ...
                                %>
                                <form method="post">
                                    <input type="text" value="<%=blogger.getId()%>" readonly/>
                                    <p>
                                        Name: <%=blogger.getName()%>
                                    </p>
                                     <p>
                                        Mobile:  <%=blogger.getMobile()%>
                                    </p>
                                     <p>
                                        City:    <%=blogger.getAddress()%>
                                    </p>
                                     <p>
                                        Email:  <%=blogger.getUserid()%>
                                    </p>
                                     <p>
                                         Pic:  <img src="../<%=blogger.getPic()%>" width="200" height="200"/>
                                    </p>
                                     <p>
                                        Current Status:  <%=blogger.getStatus()%>
                                    </p>
                                     <p>
                                         Change Status: <select name="status">
