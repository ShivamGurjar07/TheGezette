...
<html dir="ltr" lang="en">
    <head>
        ...
        <meta name="keywords" content="wrappixel, admin dashboard, html css dashboard, web dashboard, bootstrap 
             ...
             <jsp:include page="sidebar.jsp"></jsp:include>
                 ...
                 <div class="page-wrapper">
                     ...
                     <div class="container-fluid"> 
                         <h1>Write Your Reply to the Viewer </h1>
                         <form method="post">
                             ...
                             <tr>
                                 <td>Type Your Reply <br/>
                                     <textarea name="reply" rows="5" cols="20" required>
