                             ...
                             <div class="col col-md-12">
                                 <table class="table table-bordered">
                                     <tr>
                                         ...
                                         <td>Curret Status </td>
                                         <td>Blogger Name </td>
                                         <td>View Details and Change Status </td>
                                     </tr>
                                 <%
                                 ...
                                 <tr>
                                     <td> <%=blog.getId()%></td>
                                     <td> <%=blog.getTitle()%></td>
                                     <td> <img src="../<%=blog.getPic()%>" width="50" height="70"/></td>
                                     <td> <b><%=blog.getStatus()%></b></td>
                                     <td> <b><%= new BloggerDao().find(blog.getBloggerId()).getName()%> 
                                         </b></td>
                                     <td> <a href="viewBlogDetail.jsp?id=<%=blog.getId()%>"> View Details and Change Status</a></td>
                                 </tr>
                                 <%}
                                 %>
                             </table>
